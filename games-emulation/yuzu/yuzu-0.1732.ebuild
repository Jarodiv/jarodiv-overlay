...
SRC_URI="https://github.com/yuzu-emu-mirror/yuzu-mainline/archive/${MY_PV}.tar.gz -> ${P}.tar.gz
...
PATCHES=(
        "${FILESDIR}/yuzu-skip-bundled-dependencies-1732.patch"
)
...
pkg_setup() {
        ...
        wget -O "${T}/compatibility_list.json" https://raw.githubusercontent.com/flathub/org.yuzu_emu.yuzu/master/compatibility_list.json || die
}
